        ...
        try:
            ...
            if user_input == '1':
                ...
                try:
                    ...
                    print("Error: 'nano' editor could not be found on your system", file=sys.stderr)
                    print("Please install nano or ensure it is added to your system's PATH", file=sys.stderr)
                    sys.exit(1)
                ...
                with open(user_list, 'r') as file:
                    for task in file:
                        ...
                        if uniform_user_input == uniform_task:
                            ...
                            updated_tasks.append(f"{stripped_task} $DONE\n")
                        else:
